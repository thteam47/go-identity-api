...
import (
	...
	gw "github.com/thteam47/common/api/identity-api"
...
func Run(lis net.Listener, grpc_port string, http_port string) error {
	...
	err := gw.RegisterIdentityServiceHandlerFromEndpoint(ctx, gwmux, grpc_port, dialOpts)
	if err != nil {
		return err
	}
	mux := http.NewServeMux()
	mux.Handle("/", gwmux)
	mux.HandleFunc("/identity-api/", serveSwaggerFile)
...
func serveSwaggerFile(w http.ResponseWriter, r *http.Request) {
	...
	p := strings.TrimPrefix(r.URL.Path, "/identity-api")
